...
public class GiftCertificateController {
     ...
     *
     * @param queryDto  QueryDto request parameter for search by query
     ...
     */
    @GetMapping("/query")
    public List<GiftCertificateDto> findByQuery(@RequestBody QueryDto queryDto) {
        return giftCertificateService.findByQuery(queryDto);
    }
